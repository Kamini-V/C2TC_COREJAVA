...
public class PrimitiveDataType {
	public static void main(String[]args) {
		...
		System.out.println("Mininnt range of byte is: " +minInt+ "Maxint range of byte is: " +maxInt);
		...
		float f=3234.1412432783278345f;
		double d=3456014124512345678902345678914f;
